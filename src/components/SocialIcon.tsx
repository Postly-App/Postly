...
export default function SocialIcon({ platform, size = 20, className }: SocialIconProps) {
  ...
  switch (id) {
    ...
    case "threads":
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
          <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.851 1.205 8.604.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.964-.065-1.19.408-2.285 1.33-3.082.88-.76 2.119-1.207 3.583-1.291a13.853 13.853 0 013.02.142c-.126-.742-.375-1.332-.75-1.757-.513-.586-1.308-.883-2.359-.89h-.029c-.844 0-1.992.232-2.721 1.32L7.734 7.847c.98-1.454 2.568-2.256 4.478-2.256h.044c3.584 0 5.136 2.09 5.24 5.403.021.071.04.14.061.208 1.042.403 1.935 1.045 2.603 1.872 1.198 1.49 1.488 3.55.811 5.594-.706 2.138-2.265 3.845-4.3 4.797-1.326.628-2.855.93-4.485.535zM13.663 14.1l-.032-.009a11.99 11.99 0 00-2.57-.28c-.934.054-1.654.33-2.083.79-.33.35-.476.786-.452 1.295.044.82.547 1.342 1.402 1.362.104.003.21.006.317.003 1.105-.04 1.893-.47 2.378-1.28.403-.676.59-1.645.64-2.681l.4.8z" />
        </svg>
      );

    case "pinterest":
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="#BD081C" className={className}>
    ...
    case "bluesky":
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="#1185FE" className={className}>
          <path d="M12 10.8c-1.087-2.114-4.046-6.053-6.911-6.053C2.76 4.747 2 5.62 2 7.03c0 2.144 2.167 2.867 3.598 4.743C7.442 13.99 8.5 16.5 12 16.5c3.5 0 4.558-2.51 6.402-4.727C19.833 9.897 22 9.174 22 7.03 22 5.619 21.24 4.747 19.911 4.747c-2.865 0-5.824 3.939-6.911 6.053C12.583 9.77 12.262 10.2 12 10.8z" />
        </svg>
      );
    ...
    default:
      return (
        <span style={{
          ...
          background: "rgba(124,92,252,0.15)", color: "var(--clr-primary-h)",
